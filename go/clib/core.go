...
//
// libtabnasc is the c format parser as a C shared library, one of
...
// newParser builds one engine with the c grammar installed
...
func newParser() (parseFn, error) {
	j, err := plug.MakeC(); if err != nil { return nil, err }; return j.Parse, nil
}
...
// parseWith answers whether src is in the c language — and,
