...
The gated set is the reader-facing one: the package READMEs, which here
are the repository README, `ts/README.md` and `rs/README.md`. The
Rust-port series, the feasibility reports, the divergence ledger and
...
a clean run over the gated set: 156 alerts across 3 files. Those numbers
